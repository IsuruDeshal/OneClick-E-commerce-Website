  ...
  const sections = [
    {
      ...
      filters: { category: 'Desktops', tags: ['gaming'], status: 'in_stock', limitCount: 12 }
    },
    {
      sectionSelector: 'section:nth-of-type(2)',
      filters: { category: 'Desktops', tags: ['workstation'], status: 'in_stock', limitCount: 9 }
    },
    {
      sectionSelector: 'section:nth-of-type(3)',
      filters: { category: 'Desktops', tags: ['budget'], status: 'in_stock', limitCount: 9 }
    }
  ];
